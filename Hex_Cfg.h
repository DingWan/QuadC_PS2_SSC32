...
//[SSC32 Pin Numbers]
#define cLFCoxaPin      0   //Rear Right leg Hip Horizontal
#define cLFFemurPin     1   //Rear Right leg Hip Vertical
#define cLFTibiaPin     2   //Rear Right leg Knee
#define cLFTarsPin      3   // Tar

#define cLRCoxaPin      8    //Front Right leg Hip Horizontal
#define cLRFemurPin     9    //Front Right leg Hip Vertical
#define cLRTibiaPin     10   //Front Right leg Knee
#define cLRTarsPin      11   // Tar

#define cRFCoxaPin       16   //Rear Left leg Hip Horizontal
#define cRFFemurPin      17   //Rear Left leg Hip Vertical
#define cRFTibiaPin      18   //Rear Left leg Knee
#define cRFTarsPin       19   // Tar

#define cRRCoxaPin      24   //Front Left leg Hip Horizontal
#define cRRFemurPin     25   //Front Left leg Hip Vertical
#define cRRTibiaPin     26   //Front Left leg Knee
